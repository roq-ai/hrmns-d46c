...
-- AddForeignKey
ALTER TABLE "employee" ADD CONSTRAINT "employee_recruiter_id_fkey" FOREIGN KEY ("recruiter_id") REFERENCES "recruiter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
